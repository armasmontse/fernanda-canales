...
function date_from_format($date, $format)
{
    return DateTime::createFromFormat($format, $date);
}

function get_timestamp($date, $format = 'd/m/Y')
{
    $date = date_from_format($date, $format);
...
/**
 * Función para imprimir la fecha, evitar usar 
 * esta función y usar date_i18n
 * ref: https://codex.wordpress.org/Function_Reference/date_i18n
 */
function date_abr($abr, $date)
{
    return strftime($abr, get_timestamp($date));
}
